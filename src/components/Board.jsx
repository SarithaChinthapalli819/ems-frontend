...
export default function Board() {
  ...
  const projectsData= async ()=>{
    const response = await axios.get('https://ems-server-pi.vercel.app/api/board')
  ...
  const addPorject = async (projectName) => {
    ...
    try {
      const response = await axios.post('https://ems-server-pi.vercel.app/api/board/addProjects', { projectName })
  ...
  const editPorject = async (projectName) => {
    ...
    try {
      const response = await axios.put(`https://ems-server-pi.vercel.app/api/board/updateProject/${id}`, { projectName })
      if (response.data.success) {
  ...
  const deleteProject=async (id)=>{
    const response = await axios.delete(`https://ems-server-pi.vercel.app/api/board/deleteProject/${id}`)
    if (response.data.success) {
