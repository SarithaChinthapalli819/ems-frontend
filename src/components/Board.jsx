...
export default function Board() {
  ...
  const addPorject = async (projectName) => {
    ...
    try {
      const response = await axios.post('https://ems-frontend-air2.vercel.app/api/board/addProjects', { projectName })
  ...
  const editPorject = async (projectName) => {
    ...
    try {
      const response = await axios.put(`https://ems-frontend-air2.vercel.app/api/board/updateProject/${id}`, { projectName })
      if (response.data.success) {
  ...
  const deleteProject=async (id)=>{
    const response = await axios.delete(`https://ems-frontend-air2.vercel.app/api/board/deleteProject/${id}`)
    if (response.data.success) {
