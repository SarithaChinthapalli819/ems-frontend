...
export default function AllTasks() {
  ...
  const activityTabData = async () => {
    const response = await axios.get('https://ems-frontend-jkr7.vercel.app/api/tasks/getActivityData')
  ...
  const tasksValue = async () => {
    const response = await axios.get(`https://ems-frontend-jkr7.vercel.app/api/tasks/getAllTasks`)
