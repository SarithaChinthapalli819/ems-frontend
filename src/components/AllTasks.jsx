...
export default function AllTasks() {
  ...
  const activityTabData = async () => {
    const response = await axios.get('https://ems-server-pi.vercel.app/api/tasks/getActivityData')
  ...
  const tasksValue = async () => {
    const response = await axios.get(`https://ems-server-pi.vercel.app/api/tasks/getAllTasks`)
