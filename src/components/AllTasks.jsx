...
export default function AllTasks() {
  ...
  const projectsData = async () => {
    const response = await axios.get('https://ems-frontend-air2.vercel.app/api/board')
  ...
  const activityTabData = async () => {
    const response = await axios.get('https://ems-frontend-air2.vercel.app/api/tasks/getActivityData')
